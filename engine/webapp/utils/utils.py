            ...
            reformatted.append(
                {
                    ...
                    "entity_name": attr.get("entityName") or attr.get("context") or attr.get("objectName", ""),
                    "entity_description": attr.get("entityDescription") or attr.get("contextDescription", ""),
                }
            )
        except (KeyError, TypeError, ValueError) as e:
